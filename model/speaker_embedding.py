...
class PreDefinedEmbedder(nn.Module):
    def __init__(self, preprocess_config, model_config):
        ...
        self.pretrained_path = model_config["speaker_embedding"]["pretrained_path"]
        self.config_path = model_config["speaker_embedding"]
        self.hidden_size = model_config["speaker_embedding"]["embedding_model"]["lin_neurons"]
        self.embedding_size = model_config["speaker_embedding"]["embedding_size"]
    ...
    def _get_speaker_embedder(self):
        ...
        if self.embedder_type == "ECAPA-TDNN":
            embedding_model = self.config_path["embedding_model"]
