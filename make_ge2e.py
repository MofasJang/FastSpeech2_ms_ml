...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input", default="raw_data/AISHELL3",type=str, help="path of the audio_file folder.")
    parser.add_argument(
        "--pattern",
        type=str,
        default="*.wav",
    ...
    parser.add_argument(
        "--output",
        metavar="OUTPUT_DIR",
        default="preprocessed_data/AISHELL3/ge2e",
        help="path to save checkpoint and logs.")

    # load from saved checkpoint
    parser.add_argument(
        "--checkpoint_path", default="pretrained_models/ge2e_ckpt_0.3/step-3000000",type=str, help="path of the checkpoint to load")
